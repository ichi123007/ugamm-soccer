...
int main(void)
{
    ...
    while (1)
    {
        ...
        if ( f>3 )
        {
            ...
            if ( area==2||area==3 )
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            if ( (fc<170&&fc>100)&&s3<680 )
                            {
                                path=150;speed=1100;
                            }
                            else
                            {
                                if ( (fc<260&&fc>190)&&s9<680 )
                                {
                                    path=210;speed=1100;
                                }
                                else
            ...
            if ( s3<500&&fc<170&&fc>10&&f>90 )
            {
                speed=0;
            }
            else
            {
                if ( s9<500&&fc>190&&fc<350&&f>90 )
                {
                    speed=0;
                }
            }
            if ( s6<400&&(area==3||area==2) )
            {
                path=0;speed=800;
            }
            if ( (fc>80&&fc<100&&f>70)&&area==1 )
            {
                speed=0;
            }
            if ( (fc>260&&fc<280&&f>70)&&area==4 )
            {
                speed=0;
            }
            if ( s6<230&&area==1&&fc>100&&fc<170 )
            {
                speed=0;
            }
            else
            {
                if ( s6<210&&area==4&&fc>190&&fc<260 )
                {
                    speed=0;
                }
            }
            if ( s6<170&&(area==1||area==4) )
            {
                path=0;speed=800;
            }
            if ( s6>500 )
        ...
        Equation_of_motion();
        SetLCD5Char(0, 0, path, 65504, BLACK);
        SetLCD5Char(0, 20, speed, 65504, BLACK);
        SetLCD5Char(0, 40, x, 65504, BLACK);
        ...
        SetLCD5Char(0, 60, area, 65504, BLACK);
        SetLCD3Char(240, 0, line, YELLOW, BLACK);
